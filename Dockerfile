...
# docker build -t stem_app .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name stem_app stem_app
...
# Install base packages including Python and FFmpeg for audio processing
